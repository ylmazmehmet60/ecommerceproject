...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Ana</a> <a href="#">Kategoriler</a> <a href="#" class="current">Kategorileri Düzenle</a> </div>
    <h1>Kategoriler</h1>
  </div>
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="{{ url('/admin/edit-category/'.$categoryDetails->id) }}" name="edit_category" id="edit_category" novalidate="novalidate"> {{ csrf_field() }}
              <div class="control-group">
                <label class="control-label">Kategorileri Adı</label>
                <div class="controls">
                  <input type="text" name="category_name" id="category_name" value="{{ $categoryDetails->name }}">
                </div>
              </div>
			  <div class="control-group">
                <label class="control-label">Kategorileri Seviyesi</label>
                <div class="controls">
              ...
              <div class="form-actions">
                <input type="submit" value="Kategoriyi Düzenle" class="btn btn-success">
              </div>
            </form>
          </div>
        </div>
