...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Ana</a> <a href="#">Ürünler</a> <a href="#" class="current">Ürünleri Düzenle</a> </div>
    <h1>Ürünler</h1>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('admin/edit-product/'.$productDetails->id) }}" name="edit_product" id="edit_product" novalidate="novalidate">{{ csrf_field() }}
              ...
              <div class="control-group">
                <label class="control-label">Metaryal</label>
                <div class="controls">
                  ...
                  <div id="uniform-undefined">
                    <table>
                      <tr>
                        ...
                        <td>
                          @if(!empty($productDetails->image))
                            <img style="width:30px;" src="{{ asset('/images/backend_images/products/small/'.$productDetails->image) }}"> | <a href="{{ url('/admin/delete-product-image/'.$productDetails->id) }}">Sil</a>
                          @endif
                        </td>
                      </tr>
                    </table>
              ...
              <div class="form-actions">
                <input type="submit" value="Ürünü Düzenle" class="btn btn-success">
              </div>
            </form>
          </div>
        </div>
